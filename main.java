...
//						Object[] objects= new Object[Integer.valueOf(numberthread)];
						...
						String sumary_col[] = {"Total","Min","Max","Average","Throughput","Latency","ERROR %"};
						String[][] sumary_row = new String[1][7];
...
//						System.out.print(Latency);
						...
						sumary_row[0][6]=String.valueOf(errorpercent*100);
		...
		btnrqdata.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String sumary_col[] = {"Total","Min","Max","Average","Error(%)","Throughput","Latency"};
				String[][] sumary_row = new String[1] [7];
				JTable table_sumary = new JTable(sumary_row,sumary_col);
...
//				System.out.print(Latency);
				...
				sumary_row[0][6]=String.valueOf(Latency);
